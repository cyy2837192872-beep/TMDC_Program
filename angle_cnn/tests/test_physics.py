...
class TestMoirePeriod:
    def test_known_value(self):
        from angle_cnn.core.physics import moire_period
...
class TestThetaFromPeriod:
    def test_roundtrip(self):
        from angle_cnn.core.physics import moire_period, theta_from_period
    ...
    def test_small_angle(self):
        from angle_cnn.core.physics import theta_from_period
...
class TestAngleUncertainty:
    def test_decreases_with_fov(self):
        from angle_cnn.core.physics import angle_uncertainty
...
class TestFixedFov:
    ...
    def test_matches_formula(self):
        from angle_cnn.core.config import THETA_MIN
        from angle_cnn.core.physics import moire_period, FIXED_FOV_NM
...
class TestPixelsPerMoirePeriod:
    def test_matches_n_L_over_fov(self):
        from angle_cnn.core.physics import FIXED_FOV_NM, moire_period, pixels_per_moire_period
